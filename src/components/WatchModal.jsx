        ...
        <div className="relative rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/10 bg-dark-900">
          ...
          <div className="relative aspect-video flex flex-col items-center justify-center gap-4 p-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
              <button
                onClick={goDetail}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 text-white backdrop-blur hover:bg-white/20 transition-colors text-sm font-medium"
              >
                <Icon name="info" size={15} /> Ver detalhes
              </button>
              <button
                onClick={() => toggleMyList(title.id)}
                className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg backdrop-blur transition-colors text-sm font-medium ${
                  isInMyList(title.id)
